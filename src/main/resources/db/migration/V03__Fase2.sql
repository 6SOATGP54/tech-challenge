...
ALTER TABLE escopo_loja_mercado_pago
    ADD credenciais_id BIGINT;
...
ALTER TABLE escopo_caixa_mercado_pago
    ADD CONSTRAINT fk_caixa_to_loja FOREIGN KEY (store_id) REFERENCES escopo_loja_mercado_pago (user_id);

ALTER TABLE escopo_caixa_mercado_pago
    ADD idapi BIGINT;

ALTER TABLE escopo_loja_mercado_pago
    ADD CONSTRAINT fk_loja_to_credenciais FOREIGN KEY (credenciais_id) REFERENCES credenciais_acesso (id);